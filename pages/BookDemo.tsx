        ...
        <div className="grid lg:grid-cols-12 gap-8 h-full">
          ...
          <div className="lg:col-span-4">
             <div className="sticky top-32">
              ...
              <h1 className="text-4xl font-bold text-slate-900 mb-6">See FinFlow in action</h1>
          ...
          {/* Calendar Widget */}
          <Card className="lg:col-span-8 p-0 overflow-hidden flex flex-col md:flex-row min-h-[600px]">
            {/* Date Picker */}
            <div className="flex-1 p-8 border-r border-slate-100">
              <div className="flex items-center justify-between mb-8">
                <h3 className="text-lg font-bold text-slate-900">October 2024</h3>
              ...
              <div className="grid grid-cols-7 gap-2 mb-4 text-center text-xs font-semibold text-slate-400 uppercase tracking-wide">
            ...
            {/* Time Slots */}
            <div className="md:w-64 bg-slate-50 p-6 flex flex-col">
              <h3 className="text-sm font-bold text-slate-900 mb-6 uppercase tracking-wide">Available Times</h3>
              {selectedDate ? (
                ...
                <div className="flex-1 flex items-center justify-center text-center text-slate-400 text-sm px-4">
